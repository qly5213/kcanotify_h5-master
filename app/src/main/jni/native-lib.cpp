...
static const char *getIpByHttpDns(const char *hostname) {
  JNIEnv *senv;
    ...
    if ((bool )proxyEnable == JNI_TRUE && strcmp(hostname, "www.dmm.com") == 0
        || strcmp(hostname, "accounts.dmm.com") == 0
        || strcmp(hostname, "games.dmm.com") == 0
        || strcmp(hostname, "pc-play.games.dmm.com") == 0) {
        return proxyId;
    }
  return NULL;
}
...
JNICALL
Java_com_antest1_kcanotify_h5_GameBaseActivity_stringFromJNI(
    JNIEnv *env,
    jobject /* this */) {
...
Java_com_antest1_kcanotify_h5_GameBaseActivity_nativeInit(JNIEnv *env, jobject instance,
